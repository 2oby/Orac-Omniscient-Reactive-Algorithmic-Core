...
You aim to be concise, accurate, and helpful in your responses."""
    ...
    async def _update_state(self, new_state: SystemPromptState) -> None:
    ...
    async def get_current_state(self) -> Optional[SystemPromptState]:
        """Get the current system prompt state."""
        async with self._lock:
            return self._current_state

    async def get_history(self) -> list[SystemPromptState]:
