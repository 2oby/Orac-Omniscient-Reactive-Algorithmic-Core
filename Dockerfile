...
RUN CMAKE_ARGS="-DGGML_CUDA=on -DCMAKE_CUDA_ARCHITECTURES=86" CMAKE_BUILD_PARALLEL_LEVEL=1 pip install --no-cache-dir /app/llama-cpp-python --global-option="--jobs=1"
